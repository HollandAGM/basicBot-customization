(function () {
    ...
    function extend() {
        ...
        bot.commands.baconCommand = {
            command: 'putin',  //The command to be called. With the standard command literal this would be: !bacon
            ...
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    API.sendChat("/me @staff http://i.imgur.com/JIjaGCL.jpg");
                }
            }
        };
    ...
    $.getScript('https://rawgit.com/HollandAGM/basicBot/master/basicBot.js', extend);
